import { apiFetch, toast, escapeHtml, isLoggedIn, resolveMediaUrl } from "/noyau/app.js";
  ...
  return `
    <div class="row" style="justify-content:space-between;gap:10px;border:1px solid var(--border);padding:10px;border-radius:12px;margin-top:8px">
      ...
      <div class="row" style="gap:8px;align-items:center">
        <a class="btn" href="/profil/profil.html?user=${encodeURIComponent(id)}">Voir profil</a>
        ${
          isLoggedIn()
